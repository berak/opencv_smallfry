...
Original file is located at
    https://colab.research.google.com/drive/1irOhBpBpkocKoi9aH_7jMCAOAkH4lPfW
"""

!pip install opencv-python==4.2.0.34

!wget https://www.dropbox.com/s/tyhc73xa051grjp/cp_vton_gmm.onnx?dl=0 -O cp_vton_gmm.onnx
!wget https://www.dropbox.com/s/q2x97ve2h53j66k/cp_vton_tom.onnx?dl=0 -O cp_vton_tom.onnx
...
!wget 'https://drive.google.com/uc?export=dowload&id=1--Ij_gIzCeNA488u5TA4FqWMMdxBqOji' -O lightweight_pose_estimation_201912.onnx
!wget https://github.com/opencv/opencv/raw/master/samples/dnn/human_parsing.py
!wget https://images.stockfreeimages.com/802/sfi226w/8028014.jpg
!ls -l
...
if __name__ == "__main__":
    args_input_image = "person.jpg"
    args_input_cloth = "8028014.jpg"
    args_gmm_model = 'cp_vton_gmm.onnx'
    args_tom_model = 'cp_vton_tom.onnx'
    args_segmentation_model = 'lip_jppnet_384.pb'
    args_openpose_proto = ""
    args_openpose_model = 'lightweight_pose_estimation_201912.onnx'
    args_backend = cv.dnn.DNN_BACKEND_DEFAULT
    args_target = cv.dnn.DNN_TARGET_CPU

    person_img = cv.imread(args_input_image)
    ratio = 256 / 192
    ...
    cloth_img = cv.imread(args_input_cloth)
    pose = get_pose_map(person_img, args_openpose_proto,
                        args_openpose_model, args_backend, args_target)
    segm_image = parse_human(person_img, args_segmentation_model)
    segm_image = cv.resize(segm_image, (192, 256), cv.INTER_LINEAR)

    cv.dnn_registerLayer('Correlation', CorrelationLayer)

    model = CpVton(args_gmm_model, args_tom_model, args_backend, args_target)
