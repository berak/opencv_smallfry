...
class TrackerSTAPLE : public cv::Tracker {
...
public:
    ...
    {
        boundingBox = staple.tracker_staple_update(image);
...
cv::Ptr<cv::Tracker> createTrackerSTAPLE() { return cv::makePtr<TrackerSTAPLE>(); }
