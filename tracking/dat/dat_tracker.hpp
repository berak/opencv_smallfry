...
class DAT_TRACKER : public cv::Tracker
{
public:

	virtual bool initImpl(const cv::Mat& image, const cv::Rect2d& boundingBox);
	virtual bool updateImpl(const cv::Mat& image, cv::Rect2d& boundingBox);
