...
#if CV_SSE2
static const Point  pickup[64] = { {7,6},{8,6},{7,5},{8,5},{1,5},{7,4},{8,4},{1,4},{1,8},{2,8},{1,7},{2,7},{3,7},
...
static void apron(Mat v)
{
  int r = v.rows;
  int c = v.cols;
  v.row(0).setTo(0x22);    v.row(1).setTo(0x22);
  v.row(r-2).setTo(0x22);  v.row(r-1).setTo(0x22);
  v.col(0).setTo(0x22);    v.col(1).setTo(0x22);
  v.col(c-2).setTo(0x22);  v.col(c-1).setTo(0x22);
}
